    ...
    <div className='container mx-auto p-4'>
        <div>
            <table className='w-full max-w-4xl border border-gray-200 max-sm:text-sm'>
                ...
                <tbody>
                    {
                       applicants &&  applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b border-gray-200 text-center max-sm:hidden'>{applicant.jobId.title}</td>
                                <td className='py-2 px-4 border-b border-gray-200 text-center max-sm:hidden'>{applicant.jobId.location}</td>
                                ...
                                <td className='py-2 px-4 border-b border-gray-200 relative'>
                                    {
                                        ...
                                        <div className='z-10 hidden absolute right-0 top-0 mt-2 w-32 bg-white border-b border-gray-200 rounded shadow group-hover:block'>
