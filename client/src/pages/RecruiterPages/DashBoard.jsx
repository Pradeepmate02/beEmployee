        ...
        <div className='min-h-screen'>
            ...
            <div className='shadow py-4'>
                <div className='px-5 flex justify-between items-center'>
                    <img onClick={e => navigate('/')} src={assets.logo} className='max-sm:w-32 cursor-pointer' alt="" />
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                                <ul className='shadow list-none m-0 p-2 bg-white rounded-md  text-sm'>
            ...
            <div className='flex items-start'>
                {/** left sidebar with option to add jobs, manage jobs, viewApplications */}
